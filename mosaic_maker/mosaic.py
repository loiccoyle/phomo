...
class Mosaic(object):
    ...
    def tile_dir(self, value):
        ...
        self._tile_size = np.ceil(np.divide(self.master_img.size, self.grid))\
            .astype(int)
        self._mosaic_size = (self.master_img.size - self.master_img.size %
                             self.tile_size)
    ...
    def master_img(self, value):
        ...
        self._width_to_height = (self.master_img.size[0] /
                                 self.master_img.size[1])
    ...
    def tile_load(self):
        ...
        with Pool() as p:
            ...
            self.tile_arrays = list(tqdm(out, total=len(self.tiles),
                                         desc='Cropping and loading plebs'))
